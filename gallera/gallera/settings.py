"""
Django settings for gallera project.
...
SECRET_KEY = '#_4ydsl^krm&juc(fvmxsd@ka&7t2435cf3le304zas_wxq*pg'
...
WSGI_APPLICATION = 'gallera.wsgi.application'
...
# DATABASES['gallera'] = dj_database_url.config()
